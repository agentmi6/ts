...
namespace TicketSystem.WebApp.Controllers
{
    ...
    public class PrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriorityID,PriorityStatus")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorityID,PriorityStatus")] Priority priority)
        {
            if (ModelState.IsValid)
            {
